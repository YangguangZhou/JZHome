<template>
    <span>
        ...
        <div class="sponsor">
            ...
            <p class="qrcode"> <iframe src="https://pay.jerryz.com.cn/sponsor" border="0" frameborder="no" framespacing="0" allowfullscreen="true" height="654" width="100%"></iframe></p>
            <p>注：建议在支付备注栏填写你的昵称和寄语。</p>
